...
function init() {
    ...
    // Planet
    const texturePlanet = loader.load('./images/saturn-1.jpg');
    ...
    //Moon
    const textureMoon = loader.load('./images/moon-1.jpg');
    ...
    // Sphere Background 
    const textureSphereBg = loader.load('./images/stars-1.jpg');
